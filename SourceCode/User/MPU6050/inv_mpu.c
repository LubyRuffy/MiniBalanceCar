...
#define i2c_write(a, b, c, d)   IIC_Write_Buffer(a, b, c, d)
#define i2c_read(a, b, c, d)    IIC_Read_Buffer(a, b, c, d)
#define delay_ms    Delay_ms
#define get_ms      get_clock_ms
//static inline int reg_int_cb(struct int_param_s *int_param)
//{
//    return 0;//msp430_reg_int_cb(int_param->cb, int_param->pin, int_param->lp_exit, int_param->active_low);
//}
#define log_i     printf
#define log_e     printf
/* labs is already defined by TI's toolchain. */
